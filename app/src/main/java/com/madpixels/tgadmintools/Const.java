...
public class Const {
    ...
    public static final String NOTIFICATION_HIDE_CONTENT_API21 = "hide_notification_api21";
    public static final String SET_NOTIFICATION_SOUND_ENABLE = "notification_sound_enabled";
    public static final String NOTIFICATION_LOG = "logNotification";
    public static final String BAN_DEFAULT_TIME = "ban.def.time";

    public static final String BAN_DEFAULT_TIME_VALUE = "ban.def.timeval";
