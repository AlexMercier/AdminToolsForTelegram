...
public class FloatingActionButton extends View {
    ...
    public void init(int FloatingActionButtonColor) {
        ...
        mButtonPaint.setShadowLayer(3.0f, 0.0f, 3.5f, Color.argb(100, 0, 0, 0));
    ...
    static public class Builder {
        ...
        public Builder withDrawable(@DrawableRes final int drawableRes) {
            this.drawable = activity.getResources().getDrawable(drawableRes);
            ;
            return this;
        }
